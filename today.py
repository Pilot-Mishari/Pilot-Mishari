...
def graph_repos_stars(count_type, owner_affiliation, cursor=None, add_loc=0, del_loc=0):
    ...
    if request.status_code == 200:
        if count_type == 'repos':
            ...
            # FIX: filter out null nodes (repos the token can no longer see -
            # e.g. an org repo whose SSO/org access wasn't approved for this
            # token, or a repo that was deleted/transferred/made private).
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'uptime', age_data)
...
if __name__ == '__main__':
    ...
    # ---------------------------------------------------------------
    # TODO: set this to YOUR real birthdate (year, month, day).
    # You mentioned you already updated this in your working copy -
    # make sure the value below matches that, this file only carries
    # the original placeholder since I don't have your actual date.
    # ---------------------------------------------------------------
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2008, 7, 10))
